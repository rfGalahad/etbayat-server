...
export const exportHouseholdPdf = async (req, res) => {
  ...
  try {
    ...
    const pdfBuffer = await page.pdf({
      ...
      margin: { top: '20px', right: '32px', bottom: '50px', left: '32px' },
      displayHeaderFooter: true,
      headerTemplate: '<div></div>',
      footerTemplate: `
        <div style="width:100%; font-size:7pt; color:#888; padding:0 32px; display:flex; justify-content:space-between; font-family:Arial,sans-serif;">
