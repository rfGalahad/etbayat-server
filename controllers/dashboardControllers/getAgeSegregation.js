  ...
  try {
    const [rows] = await pool.query(`
      SELECT
        ...
        SUM(CASE WHEN age BETWEEN 19 AND 39 THEN 1 ELSE 0 END) AS age19_39,
        SUM(CASE WHEN age BETWEEN 40 AND 59 THEN 1 ELSE 0 END) AS age40_59,
        SUM(CASE WHEN age BETWEEN 60 AND 70 THEN 1 ELSE 0 END) AS age60_70,
        SUM(CASE WHEN age >= 71 THEN 1 ELSE 0 END) AS age71_above
