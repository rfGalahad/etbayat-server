...
export const prepareSurveyDataValues = (surveyId, formData) => {

  const expenseValues = prepareExpenseValues(surveyId, formData.expenses);
  const livestockValues = prepareLivestockValues(surveyId, formData.livestock);
  const cropsPlantedValues = prepareCropsPlantedValues(surveyId, formData.cropsPlanted);
  const fruitBearingTreeValues = prepareFruitBearingTreeValues(surveyId, formData.fruitBearingTrees);
  const familyResourcesValues = prepareFamilyResourcesValues(surveyId, formData.familyResources);
  const appliancesOwnValues = prepareAppliancesOwnValues(surveyId, formData.appliancesOwn);
  const amenitiesValues = prepareAmenitiesValues(surveyId, formData.amenities);
